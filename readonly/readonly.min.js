...
var a={warning_message:document.getElementById("warning_message").value},b=new XMLHttpRequest;b.onreadystatechange=function(){4==this.readyState&&200==this.status&&window.location.reload()};b.open("POST","/muse/data/post/hcl_readonly_"+readonly_org.org_id,!0);b.setRequestHeader("Content-type","application/json");b.send('{"client-data" : '+JSON.stringify(a)+',"script-name" : "hcl_readonly_'+readonly_org.org_id+'"}')},c=document.createElement("li"),e=document.createElement("a");c.className="ce_admin_panel";
...
disable_filedrop_upload_dialog_submit_button();window.location.pathname.startsWith("/mycontacts")&&setInterval(function(){null!==document.querySelectorAll("div.sccontact div.lotusBtnContainer")&&Array.prototype.slice.call(document.querySelectorAll("div.sccontact div.lotusBtnContainer")).forEach(function(a){a.outerHTML=""});document.querySelectorAll("div.sccontact div.networkAction ");null!==document.querySelectorAll("div.sccontact div.networkAction")&&Array.prototype.slice.call(document.querySelectorAll("div.sccontact div.networkAction")).forEach(function(a){a.outerHTML=
""})});window.location.pathname.startsWith("/profiles")&&(null!==document.getElementById("addTagButtonId")&&(lconn.profiles.SocialTags.saveNewTag=function(){return!1}),null!==document.getElementById("editProfileButton")&&(document.getElementById("editProfileButton").onClick="",document.getElementById("editProfileButton").disabled=!0),null!==document.querySelector("div.actions")&&(document.querySelector("div.actions").outerHTML=""));window.location.pathname.startsWith("/activities")&&(activites_disable_on_load(),
window.onhashchange=function(){setTimeout(activites_disable_on_load,600)},null!==document.getElementById("lconn_act_StartActivityButton_0")&&document.getElementById("lconn_act_StartActivityButton_0").addEventListener("click",function(){document.getElementById("lconn_act_NonceSaveButton_0").querySelector('input[type="button"]').disabled=!0},!1),null!==document.getElementById("editProfileButton")&&(document.getElementById("editProfileButton").onClick="",document.getElementById("editProfileButton").disabled=
!0));window.location.pathname.startsWith("/files")&&(files_disable_usability(),window.onhashchange=function(){files_disable_usability()});if(-1<window.location.pathname.indexOf("communityoverview")||-1<window.location.pathname.indexOf("communitystart"))var f=1E3,l=setInterval(function(){Array.prototype.slice.call(document.querySelectorAll("#showRichContent")).forEach(function(a){a.querySelector("a")&&(a.querySelector("a").outerHTML="")});Array.prototype.slice.call(document.querySelectorAll(".lconnActionBar")).forEach(function(a){a.outerHTML=
""});lconn.core.WidgetPlacement.openMenu=function(){return!1};f+=f/10;1250<=f&&clearInterval(l)},f);window.location.pathname.startsWith("/wikis")&&wikis_disable_on_load();if(window.location.pathname.startsWith("/communities")||window.location.pathname.startsWith("/metricssc/communitiesapp")){if(gatekeeperConfig["catalog-ui-updated"]&&gatekeeperConfig["catalog-card-view"]){null!==document.getElementById("lconn-create-community-container")&&(document.getElementById("lconn-create-community-container").outerHTML=
"");var g=0,h=setInterval(function(){g++;0<document.querySelectorAll('div[dojoattachpoint="cardResultsBody"] div.card-wrapper div.expander').length&&(clearInterval(h),0<document.querySelectorAll("div.card-wrapper div.card-details__inner div.ellipsis").length&&Array.prototype.slice.call(document.querySelectorAll("div.card-wrapper div.card-details__inner div.ellipsis")).forEach(function(a){a.outerHTML=""}),Array.prototype.slice.call(document.querySelectorAll('div[dojoattachpoint="cardResultsBody"] div.card-wrapper div.expander')).forEach(function(a){a.addEventListener("click",
function(){var a=0,b=setInterval(function(){a++;null!==document.querySelector("div.card-overflow.bx--overflow-menu")&&(document.querySelector("div.card-overflow.bx--overflow-menu").outerHTML="",clearInterval(b));20<a&&clearInterval(b)},50)},!1)}));1500<g&&clearInterval(h)},100)}null!==document.getElementById("createPlaceButton")&&(document.getElementById("createPlaceButton").addEventListener("click",function(){document.getElementById("startNewCommMenuItem").setAttribute("widgetid","");document.getElementById("copyExistingCommMenuItem").setAttribute("widgetid",
"")},!1),document.getElementById("createPlaceButton").style.visibility="hidden");if(null!==document.getElementById("Members_navItem")||-1<window.location.hash.indexOf("fullpageWidgetId=Members")){var k=function(){var a=setInterval(function(){null!==document.getElementById("controlsRow")&&(_Members_iContext.iScope().displayMemberCreateForm=function(){return!1},_Members_iContext.iScope().displayMemberInviteForm=function(){return!1},_Members_iContext.iScope().displayImport=function(){return!1},_Members_iContext.iScope().displayExport=
function(){return!1},_Members_iContext.iScope().doMemberDelete=function(){return!1},clearInterval(a))},600)};document.getElementById("Members_navItem").addEventListener("click",function(){k()},!1);k()}null!==document.getElementById("displayActionsBtn")&&document.getElementById("displayActionsBtn").addEventListener("click",function(){document.getElementById("communityMenu_EDITURL").setAttribute("widgetid","");document.getElementById("communityMenu_CREATESUB").setAttribute("widgetid","");document.getElementById("communityMenu_CUSTOMIZE").setAttribute("widgetid",
"");document.getElementById("communityMenu_CHANGELAYOUT").setAttribute("widgetid","");document.getElementById("communityMenu_EMAIL").setAttribute("widgetid","");document.getElementById("communityMenu_LEAVE").setAttribute("widgetid","");document.getElementById("communityMenu_MOVE").setAttribute("widgetid","");document.getElementById("communityMenu_DELETE").setAttribute("widgetid","");document.getElementById("communityMenu_CREATECOPY").setAttribute("widgetid","")},!1);null!==document.getElementById("joinDisplayActionsBtn")&&
...
function(){community_files_disable_on_load()}}}},1E3);function check_if_periscope_enabled(){return!!Array.prototype.slice.call(document.querySelectorAll("link[href]")).some(function(a){if(null!==a.getAttribute("href")&&-1<a.href.indexOf("repoName=cnx-custom-theme"))return!0})}
function files_disable_usability(){null!==document.getElementById("scene-body")&&(document.getElementById("scene-body").outerHTML="");null!==document.getElementById("lconn_files_action_createitem_0")&&(document.getElementById("lconn_files_action_createitem_0").disabled=!0);null!==document.querySelector(".lotusPaging")&&Array.prototype.slice.call(document.querySelectorAll(".lotusPaging li a.numShape")).forEach(function(a){null!==document.querySelectorAll("a.check.hc")&&a.addEventListener("click",function(){setTimeout(function(){files_disable_top_action();
files_disable_usability()},600)},!1);files_disable_top_action()})}function files_disable_top_action(){Array.prototype.slice.call(document.querySelectorAll("a.check.hc")).forEach(function(a){a.addEventListener("click",function(){Array.prototype.slice.call(document.querySelectorAll("#lotusContentSceneActions div.lotusBtnContainer button")).forEach(function(a,c){0!=c&&(a.disabled=!0)})},!1)})}
