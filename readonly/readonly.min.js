...
!0));window.location.pathname.startsWith("/files")&&(files_disable_usability(),window.onhashchange=function(){files_disable_usability()});if(-1<window.location.pathname.indexOf("communityoverview")||-1<window.location.pathname.indexOf("communitystart"))var f=1E3,n=setInterval(function(){Array.prototype.slice.call(document.querySelectorAll("#showRichContent")).forEach(function(a){a.querySelector("a")&&(a.querySelector("a").outerHTML="")});Array.prototype.slice.call(document.querySelectorAll(".lconnActionBar")).forEach(function(a){a.outerHTML=
""});lconn.core.WidgetPlacement.openMenu=function(){return!1};f+=f/10;1250<=f&&clearInterval(n)},f);window.location.pathname.startsWith("/wikis")&&wikis_disable_on_load();if(window.location.pathname.startsWith("/communities")||window.location.pathname.startsWith("/metricssc/communitiesapp")||window.location.pathname.startsWith("/forums")){if(gatekeeperConfig["catalog-ui-updated"]&&gatekeeperConfig["catalog-card-view"]){null!==document.getElementById("lconn-create-community-container")&&(document.getElementById("lconn-create-community-container").outerHTML=
...
function(){return!1},_Members_iContext.iScope().doMemberDelete=function(){return!1},clearInterval(a))},600)};document.getElementById("Members_navItem").addEventListener("click",function(){k()},!1);k()}if(null!==document.querySelector('li[widgetdefid="Forum"]')||window.location.pathname.startsWith("/forums")){var l=function(){var a=setInterval(function(){if(document.getElementById("topicList")||null!==document.querySelector(".dfCommunityForums")||null!==document.getElementById("forum"))document.querySelector(".lotusBtnAction").outerHTML=
"",null!==document.getElementById("forum")&&(_forum_.reply=function(){return!1},Array.prototype.slice.call(document.querySelectorAll("#forum .lotusActions")).forEach(function(a){a.outerHTML=""}),Array.prototype.slice.call(document.querySelectorAll(".lotusLikeAction")).forEach(function(a){a.outerHTML=""})),clearInterval(a)},600)};document.querySelector('li[widgetdefid="Forum"]').addEventListener("click",function(){l()},!1);l()}if(null!==document.querySelector('li[widgetdefid="Bookmarks"]')||window.location.pathname.startsWith("/communities/service/html/community/bookmarks")){var m=
