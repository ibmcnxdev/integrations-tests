...
b+';z-index:1;">'+warning_message+"</div>";var a=document.createElement("div");a.innerHTML=b;a.id="read-only-warning-message";document.getElementsByTagName("body")[0].appendChild(a);document.getElementsByTagName("body")[0].style.marginTop="65px"}};a.open("GET","/muse/data/get/hcl_readonly_"+readonly_org.org_id,!0);a.send()}
...
function(){return!1},_Members_iContext.iScope().doMemberDelete=function(){return!1},clearInterval(a))},600)};document.getElementById("Members_navItem").addEventListener("click",function(){k()},!1);k()}null!==document.getElementById("displayActionsBtn")&&(document.getElementById("displayActionsBtn").outerHTML='<a href="#">'+document.getElementById("displayActionsBtn").innerText+"</a>");null!==document.getElementById("joinDisplayActionsBtn")&&(document.getElementById("joinDisplayActionsBtn").outerHTML=
